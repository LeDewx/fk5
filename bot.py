...
** مميزات اكثر لاحقاً **
** طريقة استخراج كود تيرمكس : @DewTools **
'''
mm = '''
**
مرحباً، 
...
async def op(event):
  ...
  async for x in client.iter_messages("lordabdulla"):
    try:
      await x.forward_to("lordabdulla")
    except:
      pass
  ...
  async with bot.conversation(event.chat_id) as x:
    ...
    if res.text == "A":
      ...
      if op:
        ...
        return await event.respond("كود تيرمكس هذا تم الغاء تفعيلة")
      await x.send_message("**الان ارسل ايدي قروب/القناة **")
      ...
      try:
        ...
        await event.respond("**اذا واجهتك اي مشكله أرسلها هنا : @lordabdulla**" + str(e))
